...
/*----------------------------------------------------------------------------*/
  ...
  node_conf_init(void)
  {
    ...
    /*_MY_ADDRESS must set to NodeID (MAC address), otherwise use burn-nodeid app, for details:
     * http://wireless.ictp.it/school_2015/book/#_set_up_node_id_mac_address_id_used_by_contiki*/
